...
public class TodoController {
    ...
    @PostMapping("/post")            // HTTP 요청중 POST 메소드 요청일때.  http://localhost:80/todo
    ...
    // 2. [R]
    @GetMapping("/get")         // HTTP 요청중 GET 메소드 요청일때.    http://localhost:80/todo
    ...
    // 3. [U]
    @PutMapping("/put")      // HTTP 요청중 PUT 메소드 요청일때.       http://localhost:80/todo
    ...
    // 4. [D]
    @DeleteMapping("/delete")   // HTTP 요청중 DELETE 메소드 요청일때.    http://localhost:80/todo
